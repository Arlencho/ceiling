// Issue 156. A relay-CPI'd payment whose getTransaction body has
// logMessages null must not disappear from a no-mandate date_range.
// The file that leaves it out is not checked. It does not confirm.
...
test("a no-mandate date_range that omits a CPI payment with a null log body is not checked", async () => {
